# Feuille de route KeurFlow

Une phase à la fois. Après chaque phase : TypeScript, ESLint, tests, build, tests RLS/permissions/sécurité, vérification mobile si concerné, correction des bugs, documentation — avant de passer à la suivante.
