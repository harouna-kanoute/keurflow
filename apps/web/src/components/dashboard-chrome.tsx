  ...
  return (
    <div className="flex flex-1">
      ...
      >
        ...
        {organizationName && (
          <div className="mx-4 mb-2 rounded-xl bg-canvas px-3 py-2">
        ...
        <div className="border-t border-slate-200 p-3 dark:border-slate-800">
          ...
          <details className="group relative mt-1">
            <summary className="flex cursor-pointer list-none items-center gap-3 rounded-lg px-2 py-2 hover:bg-slate-50 dark:hover:bg-slate-800">
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-brand-100 text-sm font-semibold text-brand-700 dark:bg-brand-900 dark:text-brand-300">
            ...
            <div className="absolute bottom-full left-0 mb-2 w-full rounded-xl border border-slate-200 bg-white p-1.5 shadow-lg dark:border-slate-800 dark:bg-slate-900">
              <form action={signOut}>
                <button
                  type="submit"
      ...
      <div className="flex flex-1 flex-col lg:min-w-0">
        <div className="sticky top-0 z-20 flex h-14 shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-4 dark:border-slate-800 dark:bg-slate-900 lg:hidden">
          <button
            type="button"
          ...
          <span className="text-sm font-medium tracking-wide text-slate-900 uppercase dark:text-slate-50">
            KeurFlow
          </span>
        </div>
