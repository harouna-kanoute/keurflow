    ...
    <div className="flex flex-1 flex-col items-center bg-zinc-50 px-6 py-16 dark:bg-black">
      <div className="w-full max-w-2xl">
        ...
        <div className="mt-8 flex flex-col gap-6 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
          <section>
            <h2 className="mb-1 font-semibold text-black dark:text-zinc-50">Éditeur du site</h2>
            <p>
          ...
          <section>
            <h2 className="mb-1 font-semibold text-black dark:text-zinc-50">Hébergement</h2>
            <p>
