...
export function MilestoneStatusSelect({ milestone }: { milestone: MilestoneRow }) {
  ...
  return (
    <select
      ...
      className="rounded-lg border border-zinc-300 bg-white px-2 py-1 text-xs text-zinc-900 disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
    >
      {STATUSES.map((status) => (
